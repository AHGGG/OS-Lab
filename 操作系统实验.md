...
3. 规定坐在奇数的哲学家先拿他左边的筷子，然后拿他右边的筷子；偶数号哲学家则相反，那么1、2将竞争1号筷子，3、4将竞争3号筷子，0号不需要竞争，必定会有一位哲学家拿到筷子
    ![哲学家竞争筷子](media/16494028633430/16494162839479.jpg)
...
```
![运行截图](media/16494028633430/16494159278435.png)
...
![实验结果](assets/16538292279664.png)
...
![生产者、消费者分别回收 222222为结束输出](assets/%E6%88%AA%E5%B1%8F2022-05-29%2020.29.51.png)
...
1. C语言在Linux上编程的行缓冲及列缓冲机制
    ...
    ```
    ![代码输出结果](assets/16541549429934.jpg)
...
```
![实验结果](media/16494028633430/16494257737234.png)

### 3.5. debug纪实
![使用printf出错](assets/90048E8E8ACBE8DD1D65D6BA1AF19D80.png)
...
![实验截图](media/16494028633430/16494732226445.png)
...
![监控Amy 并使用ssh远程登录Amy用户](assets/16541543907973.jpg)
...
```
![运行结果 直接将one目录拷贝到了two目录下](media/16494028633430/16494893127987.png)
